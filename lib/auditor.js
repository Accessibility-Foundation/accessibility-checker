  ...
  rules.forEach((rule) => {
    ...
    if (Array.isArray(auditResult.results)) {
      ...
      auditResult.results.forEach((result) => {
        ...
        const cannotTellResult = result.outcome === OUTCOME.CANNOT_TELL;
        ...
        } else if (cannotTellResult) {
          ruleResult.results.cannot_tell.push(newResult);
    ...
    } else if (ruleResult.outcome === OUTCOME.CANNOT_TELL) {
      auditResults.cannot_tell.push(ruleResult);
